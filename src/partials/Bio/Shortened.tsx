    ...
    return (
        <>
            <h4>
                ...
                inherent in development. While I mainly work with TypeScript, React, and Node.js, I also enjoy working with Arduino projects (
                <em>ask me about my Halloween costumes!</em>). I'm also a big Linux fan, having been a user now for almost half my life!
            </h4>
